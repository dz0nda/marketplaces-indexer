...
from marketplaces_indexer.types.tezos_objects.tezos_object_hash import AccountAddressField
from marketplaces_indexer.types.tezos_objects.tezos_object_hash import OperationHashField
